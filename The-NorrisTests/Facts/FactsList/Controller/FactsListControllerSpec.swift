            ...
            context("when initialized") {
                ...
                context("and view loads") {
                    ...
                    it("should layout itself properly") {
                        expect(navigationMock).toEventually(haveValidSnapshot(named: "FactsListViewController_Layout_First_Time_Empty"), timeout: .milliseconds(10))
                    }
                }
                ...
                context("FactsListViewModelDelegate") {
                    ...
                    context("when didChange(facts:) is called") {
                        ...
                        it("should layout itself properly") {
                            expect(navigationMock).toEventually(haveValidSnapshot(named: "FactsListViewController_Layout_Main"), timeout: .milliseconds(10))
                        }
                    }
                    ...
                    context("when didStartRequest() is called") {
                        ...
                        it("should layout itself properly") {
                            expect(navigationMock).toEventually(haveValidSnapshot(named: "FactsListViewController_Layout_Loading"), timeout: .milliseconds(10))
                        }
                    }
                    ...
                    context("when didReceiveEmptyResult() is called") {
                        ...
                        it("should layout itself properly") {
                            expect(navigationMock).toEventually(haveValidSnapshot(named: "FactsListViewController_Layout_Empty"), timeout: .milliseconds(10))
                        }
                    }
                    ...
                    context("when didReceiveError is called") {
                        ...
                        it("should layout itself properly") {
                            expect(navigationMock).toEventually(haveValidSnapshot(named: "FactsListViewController_Layout_Error"), timeout: .milliseconds(10))
                        }
                    }
                }
            }
